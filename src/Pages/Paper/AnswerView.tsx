...
  
  // Check multiple possible paths for the child's name and grade
  // This ensures it works even if the API structure is slightly different
  const childName = singlePaper?.data?.children?.name || singlePaper?.data?.name || "N/A";
  const childGrade = singlePaper?.data?.children?.grade || singlePaper?.data?.grade || "N/A";
  
